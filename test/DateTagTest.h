...
#ifndef ObjectCube_DATE_TAG_TEST_
#define ObjectCube_DATE_TAG_TEST_

namespace ObjectCube
{
	
	class DateTagTest : public TestFixture
	{
		CPPUNIT_TEST_SUITE( DateTagTest );
	...
	private:
		...
		void testFetchByTagSetIdAndDate_( int id );
		void testInUse_();
	};
