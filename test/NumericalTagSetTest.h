...
#ifndef ObjectCube_NUMERICAL_TAG_SET_TEST_
#define ObjectCube_NUMERICAL_TAG_SET_TEST_

namespace ObjectCube
{	
	class NumericalTagSetTest : public TestFixture
	{
		CPPUNIT_TEST_SUITE( NumericalTagSetTest );
