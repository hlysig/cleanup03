...
#ifndef ObjectCube_ALPHANUMERICAL_TAG_SET_TEST_
#define ObjectCube_ALPHANUMERICAL_TAG_SET_TEST_

namespace ObjectCube
{	
	class AlphanumericalTagSetTest : public TestFixture
	{
		CPPUNIT_TEST_SUITE( AlphanumericalTagSetTest );
