...
inline void Object::_internal_set_filetype(const std::string& value) {
  ...
  filetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Object::set_filetype(const char* value) {
  ...
  filetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:MADS.Object.fileType)
}
inline void Object::set_filetype(const char* value,
    size_t size) {
  
  filetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:MADS.Object.fileType)
}
inline std::string* Object::_internal_mutable_filetype() {
  
  return filetype_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
