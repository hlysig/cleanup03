...
class OCService final {
 public:
  ...
  typedef WithAsyncMethod_getTag<Service > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_getTag<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_getTag<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_getTag<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_getTag<Service > StreamedService;
};
